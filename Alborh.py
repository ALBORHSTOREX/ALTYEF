...
os.system('https://www.facebook.com/profile.php?id=100040356279797')
...
try:
    ...
    os.system("xdg-open https://www.facebook.com/profile.php?id=100040356279797")
...
def subc():
   ...
   ses=requests.get("https://pastebin.com/YCAcVS7g").text
...
╚═╝  ╚═╝╚══════╝╚═╝      ╚═╝       ╚═╝     
  ...
  LIFE STATUS  :  ALTYEF-2000

  FB GROUP  : ALTYEF HACKER 0003
